  ...
  return (
    ...
    >
      <div className="relative mx-auto w-full max-w-[1912px]">
        ...
        <div
          className="absolute left-5 top-[10%] z-10 w-[47%] text-white sm:left-[7.2%] sm:top-[14%] sm:w-[42%]"
        ...
        >
          ...
          <h1 className="!font-[var(--font-inter)] !text-[36px] !text-white mt-2 font-extrabold leading-[1.06] tracking-[-0.05em] drop-shadow-[0_2px_8px_rgba(0,0,0,.28)] sm:mt-[1.1vw] sm:!text-[clamp(22px,2.75vw,53px)]">
            Get a Clear &amp; Glowing Skin
          </h1>
          <div className="mt-5 grid max-w-[300px] grid-cols-1 gap-2 sm:mt-[1.6vw] sm:max-w-[22vw] sm:gap-[.7vw]">
