    ...
    <footer className="relative overflow-hidden bg-[#16263f] text-white/70">
      ...
      <div className="relative mx-auto grid w-full max-w-[1180px] gap-10 px-5 py-14 max-[470px]:py-6 sm:px-8 lg:grid-cols-[1.5fr_1fr_1fr_1.2fr]">
        ...
        <div className="max-w-[34ch]">
          <img src="https://res.cloudinary.com/n0ccg2u6/image/upload/v1785391579/reshape-logo-removebg-preview_vv7uc4.png" alt="thereshape" className="h-14 w-auto" />
        ...
        <div>
          ...
          <div className="mt-4 overflow-hidden rounded-2xl border border-white/10">
            <iframe
              ...
              src="https://www.google.com/maps?q=No%20149%2C%20No%201%20Luz%20Church%20Road%2C%20Bhaskarapuram%2C%20Mylapore%2C%20Chennai%20-%20600004&output=embed"
